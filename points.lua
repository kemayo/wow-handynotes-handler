...
-- the keys ns.foldConditions folds; there was a list here, but it documented
-- keys that get deleted at registration and missed most of the ones in use.
ns.points = {}
ns.POIsToPoints = {}
